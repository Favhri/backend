// routes/laporanKunjunganRoutes.js
const express = require('express');
const router = express.Router();
const { createLaporan, getAllLaporan, updateLaporan, deleteLaporan, exportLaporan } = require('../controllers/laporanKunjunganController');
